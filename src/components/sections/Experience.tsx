        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full">
            <h2 className="text-3xl font-bold mb-12 flex items-center justify-center gap-3">
              <GraduationCap className="text-accent-green" /> Education
            </h2>
            <div className="space-y-8 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-[2px] before:bg-white/10">
              {education.map((edu, i) => (
                ...
                >
                  <div className="absolute left-0 top-1 w-10 h-10 rounded-full bg-transparent border-2 border-accent-green flex items-center justify-center z-10">
                    <div className="w-2 h-2 rounded-full bg-accent-green animate-pulse" />
                  </div>
                  <div className="glass p-6 rounded-2xl hover:bg-white/10 transition-colors group">
                    <span className="text-accent-green text-xs font-mono mb-2 block">{edu.period}</span>
