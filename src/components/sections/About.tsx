...
export default function About() {
  return (
    <section id="about" className="py-24 relative overflow-hidden bg-transparent">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <div className="relative w-full aspect-square max-w-md mx-auto">
              <div className="absolute inset-0 bg-accent-green/20 rounded-3xl blur-3xl" />
              <div className="glass h-full w-full rounded-3xl p-8 relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-4">
                  <Cpu className="w-8 h-8 text-accent-green animate-pulse" />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="glass-dark p-4 rounded-xl">
                    <p className="text-accent-green font-bold text-2xl">1 year+</p>
                    <p className="text-xs text-white/40 uppercase">Years Exp</p>
                  </div>
                  <div className="glass-dark p-4 rounded-xl">
                    <p className="text-accent-darkgreen font-bold text-2xl">3+</p>
                ...
                <div className="mt-8 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-accent-darkgreen" />
          ...
          <div className="lg:w-1/2">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-accent-green font-medium tracking-widest uppercase text-sm mb-2 flex items-center gap-2">
      ...
      {/* Background elements */}
      <div className="absolute top-1/4 -right-20 w-64 h-64 bg-accent-darkgreen/10 rounded-full blur-[100px]" />
      <div className="absolute bottom-1/4 -left-20 w-64 h-64 bg-accent-green/10 rounded-full blur-[100px]" />
    </section>
  )
}
